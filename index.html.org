...
<script>
<script src="/js/targetDatas.js" type="text/javascript"></script>
yepnope({
  load: [
	...
	<form name=selyear action="#">
	    <table>
	        <tr>
	            <th>対象データ ： </th>
	            <td>
	                <select name="selectedYear" id="year" onchange="setYear(this.form)" style="width:200px;">
